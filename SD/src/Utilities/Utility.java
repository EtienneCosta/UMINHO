...
public class Utility {
    ...
    public static void prettyTable(List<Music> musics){
        String[] headers = {"ID","Título","Artista","Ano", "Downloads","Tags"};
        Object[][] data = new Object[musics.size()][6];
        int i = 0;
        ...
        for(Music m : musics){
            ...
            data[i][3] = m.getyear();
            data[i][4] = m.getDownloads();
            data[i][5] = tagToString(m.getTags());
            i++;
        }
    ...
    public static void prettyNotify(String notify){
        ...
        String[] innerHeaders = {"ID","Artista", "Título" };
        String[][] innerData = { { parser[0], parser[1],parser[2]} };
